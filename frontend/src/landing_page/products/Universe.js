    ...
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{ width: "199px" , height: "52px" }}  src="media/images/smallcaseLogo.png" />
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{ width: "199px" , height: "52px" }} src="media\images\sensibullLogo.svg" />
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{ width: "199px" , height: "52px" }}  src="media\images\zerodhaFundhouse.png" />
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{ width: "199px" , height: "52px" }}  src="media\images\streakLogo.png" />
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{ width: "199px" , height: "52px" }}  src="media\images\tijori.svg" />
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{ width: "199px" , height: "52px" }}  src="media\images\dittoLogo.png" />
